...
const Projects = () => {
  return (
    <>
        <main className='my-24 w-full h-full lg:px-[180px] px-[50px] mt-52'>

        <p className='lightgrey font-bold text-5xl mb-4'>Projects </p>
        <p className='grey font-light md:text-2xl text-lg'>Check out some of my projects, in their different categories.</p>
                    ...
                    <div className='w-full h-full flex md:flex-row flex-col gap-10 items-end'>
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-blue-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center gap-1'>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Music Streaming App
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-orange-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center'>
                                             <img src={ FoodieApp } alt="music-streaming" className='w-32 h-36'/>

                                        </div>
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Food Delivery App
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-purple-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center'>
                                               ...
                                               <img src={ SWIJApp } alt="music-streaming" className='w-42 h-32'/>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Online Course App
                    ...
                    <div className='w-full h-full flex md:flex-row flex-col gap-10 items-end'>
                                ...
                                >
                                        <div className='w-full h-40 bg-black rounded-tr-lg rounded-tl-lg flex'>
                                              <img src={ SaintBridges } alt="7aintBridges" className='w-full'/>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>E-commerce Website
                                                    
                                                    <p className='text-sm font-regular grey'>A newsletter sign up page for an ecommerce website</p>
                                        </div>
                                        </a>
                                </div>
                                ...
                                <div className='w-full h-full mt-5'>
                                        ...
                                        <img src={ FoodieSite } alt="Foodie Landing Page" className='w-full'/>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Food Delivery Landing Page
                                ...
                                >  
                                        <div className='w-full h-40 bg-purple-600 rounded-tr-lg rounded-tl-lg flex'>
                                               <img src={ SpearAca } alt="Foodie Landing Page" className='w-full'/>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Coding School Website
                                                    
                                                    <p className='text-sm font-regular grey'>A coding school website</p>
                                        </div>
                                </a>        
                                </div>
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-pink-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center gap-1'>
                                                ...
                                                <p className='text-[1.5rem] font-black pt-5'>House of Satika</p>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'> E-commerce UI Kit  
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-blue-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center gap-1'>
                                                ...
                                                <p className='text-[2rem] font-black pt-5'>Budify</p> 
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>Budify
                                ...
                                <div className='w-full h-full mt-5'>
                                        <div className='w-full h-40 bg-green-600 rounded-tr-lg rounded-tl-lg flex items-center justify-center gap-1'>
                                                ...
                                                <p className='text-[2rem] font-black'>Foodie</p>
                                                    ...
                                                    <div className='w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-[0.2px] border-gray-700 rounded-br-lg rounded-bl-lg flex flex-col font-medium text-base lightgrey px-3 py-2'>OFood Delivery App Design

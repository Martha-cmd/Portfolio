        ...
        <div>
          ...
          <div className="mt-8 flex flex-col gap-8">
            <div className="w-full flex items-center gap-5 lightgrey">
              ...
              <a
                href="https://dribbble.com/marthadev"
                target="_blank"
            ...
            <div className="w-full flex items-center gap-5 lightgrey">
              <FaLinkedin size={18} />
              <a
                href="https://www.linkedin.com/in/marthaln/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="w-full flex items-center gap-5 lightgrey">
              ...
              <a
                href="https://github.com/Martha-cmd"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div>
          ...
          <div className="mt-5 flex gap-5 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 font-light grey text-[12px]">
